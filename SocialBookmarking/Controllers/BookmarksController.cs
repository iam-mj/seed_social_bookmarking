...
using SocialBookmarking.Data;
using SocialBookmarking.Models;
using System.Text.RegularExpressions;

// !! la index + putin la new
namespace SocialBookmarking.Controllers
{
    public class BookmarksController : Controller
    {
        ...
        public IActionResult Index(bool? orderByPopular)
        {
            ...
            /////////////////   FILTRE   ////////////////////////
            // daca nu avem rezultatele unei cautari
            ...
            if (Convert.ToString(HttpContext.Request.Query["search"]) != null)
            {
                ...
                //!!!
                // permitem filtrarea dupa filtrele noastre: recent & popular
                // => distrugem putin filtrarea dupa titlu
                if(orderByPopular == true)
                {
                    bookmarks = bookmarks.OrderByDescending(bkmk => bkmk.NrVotes);
                }
                else
                {
                    bookmarks = bookmarks.OrderByDescending(bkmk => bkmk.Date);
                }
                // pana aici
            }
        ...
        [Authorize(Roles = "RegisteredUser,Administrator")]
        [HttpPost]
        public async Task<IActionResult> New(Bookmark bkmk, IFormFile? BookmarkImage,
